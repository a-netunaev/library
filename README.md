...
Данный сайт предназначен для работника библиотеки. Ввода и просмотра книг, хранящихся в библиотеке пользователя. Добавление новых книг, а так же вносить изменения в состав книг, находящихся в библиотеке
