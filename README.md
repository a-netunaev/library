...
6. Загрузите все файлы из папок src в папку www (или public_html) на хостинге.
7. Загрузите все файлы из папок img в папку www/img (или public_html/img) на хостинге.
